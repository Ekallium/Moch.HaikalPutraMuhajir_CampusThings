    ...
    public static void main(String[] args) {
        ...
        if (inputId.equals(id) && inputPin == pin){
            ...
            switch (pilihan){
                ...
                break;
                case 2 : System.out.println("Jumlah Uang Yang Ingin Anda Tarik\nRp");
                ...
                case 4 : System.out.println("Terimakasih Telah Menggunakan Bank Jali");
                break;
                default : System.out.println("Harap Masukkan Menu Yang Valid !");
            } scan.close();
        }   else{
